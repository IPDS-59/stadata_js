...
- **ci**: add safe label creation mechanism ([4887d6a])
- **trade**: add trade module for foreign trade data (#36) ([5625009])
...
- **ci**: filter create event to only release/hotfix branches ([8169670])
- **ci**: resolve PR title validation and bundle size comparison issues ([479731e])
- **ci**: resolve yaml syntax errors in create-release-pr workflow ([78a28a4])
- **ci**: resolve yaml syntax error in create-release-pr workflow ([ad521f2])
...
- update changelog for version 0.1.0 (#37) ([ec22097])
- update changelog for version 0.1.0 ([54d2cd6])
