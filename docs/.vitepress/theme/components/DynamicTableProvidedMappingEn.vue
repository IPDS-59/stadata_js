...
<div class="page-title">BPS API — JSON response → table mapping</div>
<div class="page-sub">How to decode the <code style="font-family:'JetBrains Mono',monospace;color:var(--teal-tx);font-size:12px;">datacontent</code> key and render a multi-level header table</div>

<!-- KEY ANATOMY -->
<div class="section">
  <div class="section-label">Key Anatomy</div>
  <div class="key-row">
    ...
    <span style="font-family:'JetBrains Mono',monospace;font-size:13px;color:var(--sub);">concat of <code style="color:var(--text)">val</code> fields</span>
  </div>

  <div class="key-row">
    <span style="font-size:13px;color:var(--sub);margin-right:8px;">Example (Pinrang / Kec A / 1999 / Feb):</span>
  ...
  <div class="key-note">⚠ Key length is variable — always build by lookup, never fixed-width split.</div>
</div>
...
<div class="two-panel">
  ...
  <!-- JSON panel -->
  <div class="panel">
    <div class="panel-title">JSON Response (Case D — all dimensions)</div>
  ...
  <!-- Rules panel -->
  <div class="panel">
    <div class="panel-title">Header Row Rules</div>

    <div class="rule-row">
      <div class="rule-num">Row 1</div>
      <div class="rule-body">
        <span class="pill pill-teal">tahun</span>&nbsp; <span style="color:var(--sub);font-size:12px;">— always shown</span>
        <div class="rule-desc">colspan = count(turtahun) × count(turvar)</div>
      </div>
    </div>
    <div class="rule-row">
      <div class="rule-num">Row 2</div>
      <div class="rule-body">
        <span class="pill pill-purple">turtahun</span>&nbsp; <span style="color:var(--sub);font-size:12px;">— skip if only 1 value</span>
        <div class="rule-desc">colspan = count(turvar)</div>
      </div>
    </div>
    <div class="rule-row">
      <div class="rule-num">Row 3</div>
      <div class="rule-body">
        <span class="pill pill-amber">turvar</span>&nbsp; <span style="color:var(--sub);font-size:12px;">— skip if only 1 value</span>
        <div class="rule-desc">colspan = 1 &nbsp;(leaf column)</div>
      </div>
    </div>
    <div class="rule-row">
      ...
      <div class="rule-body">
        ...
        <div class="rule-desc">= total header rows rendered (1, 2, or 3)</div>
      </div>
    </div>

    <div style="margin-top:24px;">
      <div class="panel-title">Cases at a glance</div>
      <div class="case-table">
        <div class="case-table-row">
          <span class="case-id">A</span>
          <span class="case-cond">single turvar + single turtahun</span>
          <span class="case-result">1 header row</span>
        </div>
        <div class="case-table-row">
          <span class="case-id">B</span>
          <span class="case-cond">multiple turvar, single turtahun</span>
          <span class="case-result">2 rows: tahun → turvar</span>
        </div>
        <div class="case-table-row">
          <span class="case-id">C</span>
          <span class="case-cond">single turvar, multiple turtahun</span>
          <span class="case-result">2 rows: tahun → turtahun</span>
        </div>
        <div class="case-table-row">
          <span class="case-id">D</span>
          <span class="case-cond">multiple turvar + multiple turtahun</span>
          <span class="case-result">3 rows: tahun → turtahun → turvar</span>
        </div>
      </div>
    </div>
...
<div class="case-block">
  <div class="case-heading">
    ...
    <span class="case-desc">Single turvar + single turtahun — 1 header row</span>
  </div>
  <div class="tbl-wrap">
    <table>
      <thead>
  ...
  <div class="key-annot">
    <span class="arrow">↑ 1999 cell key:</span>
    <span class="pill pill-blue">7315</span>
    <span class="pill pill-pink">31</span>
...
<div class="case-block">
  <div class="case-heading">
    ...
    <span class="case-desc">Multiple turvar, single turtahun — 2 header rows (tahun → turvar)</span>
  </div>
  <div class="tbl-wrap">
    <table>
      <thead>
  ...
  <div class="key-annot">
    <span class="arrow">↑ tahun colspan =</span>
...
<div class="case-block">
  <div class="case-heading">
    ...
    <span class="case-desc">Single turvar, multiple turtahun — 2 header rows (tahun → turtahun)</span>
  </div>
  <div class="tbl-wrap">
    <table>
      <thead>
...
<div class="case-block">
  <div class="case-heading">
    ...
    <span class="case-desc">Multiple turvar + multiple turtahun — 3 header rows (tahun → turtahun → turvar)</span>
  </div>
  <div class="tbl-wrap">
    <table>
      <thead>
  ...
  <div class="key-annot" style="flex-direction:column;align-items:flex-start;gap:6px;">
    ...
    <div style="display:flex;align-items:center;gap:6px;">
      <span class="arrow">↑ turtahun colspan =</span>
      <code style="font-family:'JetBrains Mono',monospace;font-size:12px;color:var(--amber-tx);">count(turvar)</code>
      <span style="color:var(--muted)">=</span>
      <span style="color:var(--text);font-family:'JetBrains Mono',monospace;font-size:12px;">2</span>
    </div>
